...
project_name='EasyR1-timethinker-rl'
exp_name='qwen3_vl_timethinker-rl'

MODEL_PATH=models/TimeThinker-4B-SFT
TRAIN_FILE="timethinker_rl_train.json"
TEST_FILE="timethinker_rl_train.json"
